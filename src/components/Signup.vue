<template>
    <div class="body" v-bind:style="{ backgroundImage: 'url(' + backimg + ')' }">
                <div class="form-group w-75 bg-white text-dark p-5 mx-auto rounded">
                    ...
                    <small id="emailHelpId" class="form-text text-muted text-white">*For a stronger password make sure it reaches upto a minimum of 8 cahracters</small>
                    ...
                    <button class="btn btn-secondary btn-sm mt-2 mb-2">Choose avatar</button>
